var relearn_searchindex = [
  ...
  },
  {
    ...
    "content": "Activity 1 - Coding Ode to Joy Pair Programming Video Tutorial Resources\nOde to Joy Sheet Music Reading Music Handout Activity #2: Turtle Graphics Starter Project",
    "description": "Activity 1 - Coding Ode to Joy Pair Programming Video Tutorial Resources\nOde to Joy Sheet Music Reading Music Handout Activity #2: Turtle Graphics Starter Project",
    "tags": [],
    "title": "Day 1",
  ...
  {
    "breadcrumb": "Computer Science Extra",
    "content": "Activity 1 - PacMan Part I PacMan Video Resources\nPacMan Starter File Activity 2 - PacMan Part II PacMan Video Part 2 Resources\nPacMan Part 2 Starter File",
    "description": "Activity 1 - PacMan Part I PacMan Video Resources\nPacMan Starter File Activity 2 - PacMan Part II PacMan Video Part 2 Resources\nPacMan Part 2 Starter File",
    "tags": [],
    "title": "Day 2",
  ...
  {
    "breadcrumb": "Computer Science",
    "content": "Activity 1 - Introduction to State Machines Starter Project\nTutorial Activity 2: Elevator State Machines Starter Project\nTutorial 1 Tutorial 2 Tutorial 3 Activity 3: Drone State Machine Starter Project",
    "description": "Activity 1 - Introduction to State Machines Starter Project\nTutorial Activity 2: Elevator State Machines Starter Project\nTutorial 1 Tutorial 2",
    "tags": [],
    "title": "Day 2",
  ...
  {
    "breadcrumb": "Computer Science",
    "content": "Activity 1: Drone Movement Builds off the drone state machine from Day 2\nDrone Movement Lateral Drone Movement Rotational Drone Movement Drone Art\nActivity 2: Models and Simulation Part I Tutorial Virtual Beocat Tour Visit https://kstate.designori.net/ and select “Beocat Supercomputer”\nActivity 3: Models \u0026 Simulations Part II Activity 4: Graphing Mathematical Functions Starter Project\nTutorial Activity 5: Q\u0026A with Dr. Bean (on Zoom)",
  ...
  },
  {
    ...
    "tags": [],
    "title": "Categories",
    "uri": "/ks-leapes/categories/index.html"
  },
  {
    "breadcrumb": "",
    "content": "Kansas LEAPES (Learning, Exploration, and Application for Prospective Engineering Students) seeks to spark interest in science, technology, engineering, and mathematics (STEM) careers among 7th–12th grade students statewide. The KS LEAPES program operates a novel distributed STEM summer camp, with local camps hosted in schools across the state, offering program developed and led by K-State faculty.\nHost a Camp If you are interested in hosting a LEAPES site, please contact the Rural Education Center at Kansas State University.\nSupport Us! The Rural Education Center is seeking grant and/ or philanthropic support so that future summer STEM camps can continue to build on this proven success—empowering students, strengthening schools, and ensuring that Kansas remains a place where young people dream big and achieve even bigger!\nThis website serves as a repository for the curriculum used in the KS LEAPES camps, which are released under a Creative Commons NA-NC-ShareAlike license.",
